...
archive="${LLVM_ARCHIVE:-${tools_dir}/llvm-project-19.1.7.src.tar.xz}"
source_dir="${LLVM_SOURCE_DIR:-${tools_dir}/llvm-project-19.1.7.src}"
build_dir="${LLVM_BUILD_DIR:-${tools_dir}/llvm-project-19.1.7.build}"
install_dir="${STANDALONE_LLVM_PREFIX:-${tools_dir}/llvm-19.1.7}"
