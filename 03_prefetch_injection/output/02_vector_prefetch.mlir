              ...
              scf.for %arg8 = %c0 to %3 step %c16_vscale {
                ...
                scf.for %arg9 = %c0 to %5 step %c16_vscale_3 {
                  ...
                  scf.for %arg10 = %c0 to %7 step %c1 {
                    ...
                    memref.prefetch %subview_10[%c0], read, locality<3>, data : memref<?xf32, strided<[?], offset: ?>>
                    ...
                    memref.prefetch %subview_11[%c0], read, locality<3>, data : memref<?xf32, strided<[1], offset: ?>>
