...
| Runtime/PMU | 部分使用 | CPU cycle 微基准校准 latency/useful cycles；正确性、运行时间、中位加速比和全局收益阈值；自动回写服务器 Profile | L1/L2/LLC miss、stall、带宽、TLB、污染事件和多线程压力归因 |
